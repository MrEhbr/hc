...
//
//     plutil -convert json -r -o $GOPATH/src/hc/gen/metadata.json /Applications/HomeKit\ Accessory\ Simulator.app/Contents/Frameworks/HAPAccessoryKit.framework/Versions/A/Resources/default.metadata.plist
package main
...
var LibPath = os.ExpandEnv("$GOPATH/src/hc")
